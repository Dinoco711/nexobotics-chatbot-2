...
spreadsheet_id = 'Chatbot Conversations'  # Replace with your spreadsheet ID
sheet = gc.open_by_key(spreadsheet_id).Chats  # Open the first sheet

def log_chat_to_sheet(user_message, bot_response):
    # Append the chat log to the sheet
...
def chat_endpoint():
    ...
    try:
        ...
        # Log both user and bot messages to Google Sheets
        log_chat_to_sheet(message, bot_response)
